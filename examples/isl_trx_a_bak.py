...
# Title: ISL_TRX_A
# Generated: Sat Jun 23 21:24:46 2018
##################################################
...
class isl_trx_a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_f(
        	1024, #size
        	samp_rate/1024, #samp_rate
        	"", #name
        	1 #number of inputs
        )
        self.qtgui_time_sink_x_0.set_update_time(0.10)
        self.qtgui_time_sink_x_0.set_y_axis(2.4, 2.46)
        ...
        self.isl_vector_get_element_ff_0 = isl.vector_get_element_ff(1024, 341)
        ...
        self.blocks_complex_to_magphase_0 = blocks.complex_to_magphase(1024)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_time_sink_x_0.set_samp_rate(self.samp_rate/1024)
